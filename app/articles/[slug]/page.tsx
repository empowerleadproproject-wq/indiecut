...
export async function generateMetadata({params}:{params:{slug:string}}):Promise<Metadata>{
 ...
 const url=`${SITE_URL}/articles/${encodeURIComponent(data.slug)}`;const description=data.subheadline||data.headline;const image=data.featured_media_url&&!video(data.featured_media_url)?data.featured_media_url:undefined;
