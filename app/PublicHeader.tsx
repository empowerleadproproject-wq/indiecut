export default function PublicHeader(){
 const links=[['/','HOME'],['/movies','MOVIES'],['/tv','TV'],['/music','MUSIC'],['/battles','LIVE BATTLES'],['/culture','CULTURE'],['/independent','INDEPENDENT'],['/indie-spotlight','INDIE SPOTLIGHT'],['/distribution','FILM DISTRIBUTION'],['/videos','WATCH'],['/articles','LATEST']];
