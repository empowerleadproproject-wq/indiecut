export default function PublicHeader(){
 const links=[['/','HOME'],['/movies','MOVIES'],['/tv','TV'],['/music','MUSIC'],['/the-cut','THE CUT'],['/battles','LIVE BATTLES'],['/culture','CULTURE'],['/independent','INDEPENDENT'],['/videos','WATCH'],['/articles','LATEST']];
