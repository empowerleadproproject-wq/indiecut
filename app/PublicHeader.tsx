export default function PublicHeader(){
 const links=[['/','HOME'],['/movies','MOVIES'],['/tv','TV'],['/music','MUSIC'],['/battles','LIVE BATTLES'],['/culture','CULTURE'],['/independent','INDEPENDENT'],['/videos','WATCH'],['/rewards','WATCH & EARN'],['/articles','LATEST']];
