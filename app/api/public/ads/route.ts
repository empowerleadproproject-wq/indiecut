...
function placementMatches(ad:any,requested:string){if(!requested)return true;const placement=String(ad?.placement||'');return placement===requested||placement==='sitewide'}
