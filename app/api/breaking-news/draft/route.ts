...
export async function POST(request:Request){
 ...
 return NextResponse.json({ok:true,id:created.id,headline:created.headline,slug:created.slug,status:created.status,sources:sources.length});
}
