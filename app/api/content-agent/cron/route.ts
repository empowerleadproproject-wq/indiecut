...
const DEFAULTS={enabled:true,default_topic:'top current entertainment news involving Black culture, movies, television, music and celebrities',default_count:3,require_multiple_sources:true,reject_rumors:true,frequency:'daily',cron_hour:9,cron_day:1,cron_timezone:'America/New_York'};
