...
export async function POST(request:Request){
 ...
 if(action==='create_article'){
  ...
  const prompt=`You are an Indie Cut music editor. Re-check the current public web and write a factual, energetic music-news/profile article about this rising artist. Use the supplied lead only as a starting point: ${context}. Verify all material claims with live web search. Do not invent quotes, numbers, label status, relationships, biography details or achievements. If independence cannot be confirmed, say that clearly rather than claiming the artist is independent. Write original copy for Indie Cut, with a sharp headline, concise subheadline, and 5-7 substantial paragraphs. Focus on why the artist matters now, the latest release, momentum and the supplied Indie Cut angle. CRITICAL ARTICLE FORMAT: The body is clean publication copy only. NEVER put URLs, hyperlinks, Markdown links, citation markers, source domains, parenthetical source links, footnotes, bracket citations, or strings such as ([site.com](https://...)) inside the headline, subheadline, or body. Put every research/source URL ONLY in the separate sources array. The reader-facing article must read like finished entertainment journalism, not a research report. Return ONLY valid JSON: {"headline":"","subheadline":"","body":"","subject_name":"","sources":["https://..."],"verification_status":"verified|not_verified","verification_note":""}.`;
