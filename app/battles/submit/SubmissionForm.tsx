...
export default function SubmissionForm({open=true}:{open?:boolean}){
 ...
 return <form className={styles.submissionForm} onSubmit={submit}>
  ...
  <div className={styles.formGrid}><label>Artist photo <span>optional</span><input name="artist_photo" type="file" accept="image/*"/></label><label>Upload your song <span>MP3, MP4, or WAV</span><input name="track_file" type="file" accept=".mp3,.mp4,.wav,audio/mpeg,audio/mp4,audio/wav,audio/x-wav,video/mp4" required/></label></div>
