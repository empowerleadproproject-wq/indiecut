...
const sections:Record<string,{title:string;intro:string}>={
 ...
 'live-battles':{title:'Live Battles',intro:'Control the Live Battles front door, artist submissions, fan qualifying, the three-person stage, sponsor breaks, round votes and bracket results.'},
