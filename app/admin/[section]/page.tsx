...
const sections:Record<string,{title:string;intro:string}>={
 ...
 'live-battles':{title:'Live Battles',intro:'Run fan qualifying, upload artist tracks, control the live three-person stage, sponsor breaks, round votes and bracket results.'},
