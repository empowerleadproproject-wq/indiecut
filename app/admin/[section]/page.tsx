...
const sections:Record<string,{title:string;intro:string}>={
 ...
 crm:{title:'Artist CRM',intro:'Run the autonomous CRM agent, own artist relationships, campaigns and opportunities, create IndieCut article drafts, and distribute professional artist press releases from one system.'},
