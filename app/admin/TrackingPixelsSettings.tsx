...
export default function TrackingPixelsSettings(){
 ...
 return <>
  <section className="ic-module-panel" style={{marginBottom:18}}><div className="ic-admin-eyebrow">RETARGETING + ATTRIBUTION</div><h2>Tracking & Pixels</h2><p>Add your platform IDs here — no code required. Indie Cut will load them sitewide for public visitors and will automatically exclude you while you are signed into the admin account.</p><p style={{marginBottom:0}}><strong>Built-in events:</strong> page views, battle views, artist profile views, rankings views, votes, shares, submission-page visits and completed artist submissions.</p></section>
  ...
  <button type="button" onClick={save} disabled={busy} style={{marginBottom:28}}>{busy?'SAVING…':'SAVE TRACKING SETTINGS'}</button>
 </>;
}
