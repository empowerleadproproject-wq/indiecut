create table if not exists public.crm_press_releases (
  ...
  distribution_plan text not null default 'basic',
  ...
  status text not null default 'draft' check (status in ('draft','generated','article_drafted','submitted','distributed','rejected','refunded')),
